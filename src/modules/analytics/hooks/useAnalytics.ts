...
const MOCK_ANALYTICS_DATA: AnalyticsData = {
  userData: {
    ...
    skillRadar: [
      { skill: 'Design', points: 850, maxPoints: 1000 },
    ...
    exportData: [
      { date: '2024-01-01', taskType: 'Arena', points: 50, skill: 'Design' },
      ...
      { date: '2024-01-05', taskType: 'Learning', points: 35, skill: 'Design' },
      ...
      { date: '2024-01-09', taskType: 'Gigs', points: 80, skill: 'Design' },
